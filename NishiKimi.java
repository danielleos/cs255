...
public class NishiKimi extends Robot {
	...
	public void onScannedRobot(ScannedRobotEvent e) {
        ...
        /*  run this option with a certain probability
         *  run another option with a different probability
         */
        
        setTurnRight(e.getBearing() + 90 - 30*moveDirection); //stay at 90 degrees from bot
        ...
        //if bot had small energy drop, assume it fired a bullet
